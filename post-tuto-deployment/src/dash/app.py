...
home_layout = html.Div(
    [
        ...
        html.P(
            [
                "This API, front end, back end, and machine learning project was built by ",
                html.A("Isaac Mather", href="https://www.linkedin.com/in/isaacmather/", target="_blank"),
                " in 2020 based on the work of ",
                html.A("Ahmed Besbes", href="https://ahmedbesbes.com", target="_blank"),
                " and ",
                html.A("Marwan Debbiche", href="https://marwandebbiche.com",
                       target="_blank"),
                " in 2019. My thanks to them."
            ],
